...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#746a62'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '54px', 'lineheight' => '54px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fe8301'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '24px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#545454'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#545454'));
			...
			$options['pinterest_icon'] = array( 
								...
								"desc" => "Pinterest Icon",
								"id" => "pinterest_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/pinterest.png",
								"type" => "upload");
			...
			$options['linkedin_icon'] = array(
								...
								"desc" => "Linkedin Icon",
								"id" => "linkedin_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/linkedin.png",
								"type" => "upload");
			//End Social Links
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '53px', 'lineheight' => '60px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fe8301'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '24px', 'lineheight' => '31px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#888888'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '18px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
